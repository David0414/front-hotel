...
var divWithClassName_default = (className) => React16.forwardRef((p, ref) => (0, import_jsx_runtime10.jsx)("div", {
  ...p,
  ref,
...
var Carousel = React45.forwardRef(({
...
var FormLabel = React78.forwardRef(({
  ...
  return (
    ...
    (0, import_jsx_runtime69.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var TabContent = React139.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React140.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React143.forwardRef((props, ref) => (0, import_jsx_runtime142.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React144.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React145.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastBody = React146.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React148.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React149.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React150.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime151.jsx)(ButtonGroup_default, {
    ...
    children: map(children, (child) => {
      ...
      return React150.cloneElement(child, {
        type,
